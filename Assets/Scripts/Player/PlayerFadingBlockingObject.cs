...
public class PlayerFadingBlockingObject : MonoBehaviour
{
    ...
    [SerializeField] public Transform tr_target; // to editor
    [SerializeField] public Camera cam_cameraToCastRay;// to editor
    [Range(0f, 1f)]
    ...
    [SerializeField] public Vector3 v3_targetPositionOffset = Vector3.up; // to editor
    ...
    [HideInInspector] public Ray r_rayFromCam;
